...
const DialogContent = React.forwardRef((_a, ref) => {
    ...
    return (<DialogPortal>
    <DialogOverlay />
    <DialogPrimitive.Content ref={ref} className={cn("fixed inset-0 sm:inset-auto sm:left-[50%] sm:top-[50%] z-50 grid w-full sm:max-w-lg sm:translate-x-[-50%] sm:translate-y-[-50%] gap-4 border-0 sm:border bg-background p-4 md:p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg h-full sm:h-auto", className)} {...props}>
      {children}
