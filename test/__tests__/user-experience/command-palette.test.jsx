...
function CommandPaletteTestWrapper({ workspaceSlug = 'test-workspace', onCreateIssue = vi.fn(), onToggleViewMode = vi.fn(), onToggleSearch = vi.fn(), }) {
    return (<CommandPaletteProvider>
      <CommandPalette workspaceSlug={workspaceSlug} onCreateIssue={onCreateIssue} onToggleViewMode={onToggleViewMode} onToggleSearch={onToggleSearch}/>
