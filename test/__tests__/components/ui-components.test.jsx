...
describe('UI Components', () => {
    ...
    describe('Input Component', () => {
        ...
        it('supports different input types', () => {
            ...
            render(<div>
          {types.map(type => (<Input key={type} type={type} placeholder={`${type} input`}/>))}
        </div>);
            types.forEach(type => {
    ...
    describe('Markdown Editor Component', () => {
        it('handles text changes', async () => {
            const onChange = vi.fn();
            const user = userEvent.setup();
            render(<MarkdownEditor value="" onChange={onChange} placeholder="Type markdown..."/>);
    ...
    describe('Label Component', () => {
        ...
        it('supports required indicator', () => {
            render(<Label htmlFor="required-input">
    ...
    describe('Error States', () => {
        it('displays input error state', () => {
            render(<div>
          <Input className="border-red-500" aria-invalid="true" placeholder="Error input"/>
        </div>);
    ...
    describe('Empty States', () => {
        it('renders empty state with icon and message', () => {
            const EmptyState = ({ title, message }) => (<div className="text-center py-12">
          ...
          <p className="mt-1 text-sm text-gray-500">{message}</p>
            ...
            render(<EmptyState title="No results found" message="Try adjusting your search or filters"/>);
